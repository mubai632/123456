...
export default {
  ...
  methods: {
	...
	this.ruleForm.kechengneirong = this.ruleForm.kechengneirong.replace(reg,'../../../course/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
