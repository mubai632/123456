<template>
  <el-breadcrumb class="app-breadcrumb" separator="⭐" style="height:50px;backgroundColor:rgba(231, 228, 255, 1);borderRadius:20px;padding:;boxShadow:;borderWidth:2px;borderStyle:;borderColor:rgba(255, 215, 0, 1);">
