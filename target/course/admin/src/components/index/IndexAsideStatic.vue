<template>
  <el-aside class="index-aside" width="158px">
      ...
      <div v-for="item in menuList" :key="item.roleName" v-if="role==item.roleName" class="menulist-item">
		...
		<el-menu :mode="2 == 1? 'horizontal':'vertical'" :unique-opened="true" class="el-menu-demo" default-active="0">
          ...
          <el-submenu :index="1+''">
            ...
            <el-menu-item :index="1-1" @click="menuHandler('updatePassword')">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp修改密码</el-menu-item>
            <el-menu-item :index="1-2" @click="menuHandler('center')">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp个人信息</el-menu-item>
          </el-submenu>
          <el-submenu v-for=" (menu,index) in item.backMenu" :key="menu.menu" :index="index+2+''">
            ...
            <el-menu-item v-for=" (child,sort) in menu.child" :key="sort" :index="(index+2)+'-'+sort" @click="menuHandler(child.tableName)">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp{{ child.menu }}</el-menu-item>
          </el-submenu>
        </el-menu>
      </div>
    </div>
...
<style lang="scss" scoped>
  ...
  .index-aside {
	...
	background-color: rgb(255, 255, 255);
		...
		// 	border-width: 0;
		// 	border-style: dashed;
		// 	border-color: rgb(41, 111, 45) !important;
		// 	background-color: rgb(53, 105, 31) !important;
      ...
      background-color:rgba(255, 255, 224, 0.8);
		...
		// 	box-shadow: 0 0 0px rgba(0, 0, 0, .3);
			...
			.el-menu-item {
				...
				background-color: rgba(231, 228, 255, 1) !important;
